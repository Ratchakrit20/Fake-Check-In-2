...
ระบบนี้ช่วยตรวจว่าภาพสองภาพหรือภาพจำนวนมากมีความสัมพันธ์กันหรือไม่ เช่น ไฟล์เดียวกัน ภาพเดิมที่บีบอัดใหม่ ภาพกลับด้าน ภาพครอปหรือเบลอ ภาพที่ถ่ายซ้ำผ่านหน้าจอ และการนำบุคคลหรือส่วนของภาพเดิมไปเปลี่ยนฉาก
...
การจัดกลุ่มใช้ connected components เช่น 1 เชื่อม 2, 1 เชื่อม 3 และ 3 เชื่อม 4 ระบบจะรวม 1, 2, 3, 4 เป็นกลุ่มเดียว แม้ 1 จะไม่เชื่อมกับ 4 โดยตรง
...
│  │  ├─ perceptual_hash_detector.py สร้าง pHash และ pHash ของภาพกลับด้าน
...
เข้าเมนู “กลุ่มภาพสัมพันธ์” กลุ่มเกิดจากเส้นเชื่อมที่ผ่านคำตัดสิน ไม่จำเป็นต้องให้ทุกภาพสัมพันธ์กันโดยตรง
